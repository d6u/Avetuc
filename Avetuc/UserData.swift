...
extension UserData: Decodable {
    ...
    static func create(created_at: String)(description: String)(favourites_count: Int64)(followers_count: Int64)(following: Bool)(friends_count: Int64)(id_str: String)(lang: String)(listed_count: Int64)(location: String)(name: String)(profile_image_url: String)(screen_name: String)(statuses_count: Int64)(time_zone: String?)(unread_count: Int64?)(url: String?)(utc_offset: Int64?)(verified: Bool) -> UserData
    {
    ...
    static func decode(j: JSON) -> Decoded<UserData> {
        ...
        typealias Halved = Decoded<String -> String -> String -> Int64 -> String? -> Int64? -> String? -> Int64? -> Bool -> UserData>

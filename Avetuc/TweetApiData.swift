...
extension TweetData: Decodable {
    ...
    static func create
        ...
        (text: String)
        (entities: Entities)
        (text_with_entities: String?)
        (creator_user_id: String)
        (retweeted_tweet_id: String?)
        (quoted_tweet_id: String?)
        (master_account_user_id: String?) -> TweetData
    {
        return TweetData(created_at: created_at, favorite_count: favorite_count, favorited: favorited, id_str: id_str, in_reply_to_screen_name: in_reply_to_screen_name, in_reply_to_status_id_str: in_reply_to_status_id_str, in_reply_to_user_id_str: in_reply_to_user_id_str, is_read: is_read, lang: lang, retweet_count: retweet_count, retweeted: retweeted, text: text, entities: entities, text_with_entities: text_with_entities, creator_user_id: creator_user_id, retweeted_tweet_id: retweeted_tweet_id, quoted_tweet_id: quoted_tweet_id, master_account_user_id: master_account_user_id)
    }
    ...
    static func decode(j: JSON) -> Decoded<TweetData> {
        ...
        typealias Halved = Decoded<Int64 -> Bool -> String -> Entities -> String? -> String -> String? -> String? -> String? -> TweetData>
